...
public class CategoryControllerMockMvcTest {
    ...
    public void findAllTest() throws Exception {
        ...
        categories.add(CategoryDto.builder().id(1L).title("Food").build());
        categories.add(CategoryDto.builder().id(2L).title("Furniture").build());
    ...
    public void saveCategoryTest() throws Exception {
        ...
        given(categoryService.save(any())).willReturn(new CategoryDto(1L, "Weapon"));
    ...
    public void saveExistingCategoryTest() throws Exception {
        ...
        given(categoryService.findById(1L)).willReturn(new CategoryDto(1L, "Food"));
